...
// to do:
// incluir a coluna do serviço na query que retorna o evento disparado;
...
// adicionar o viper para uso das variaveis e configuração/leitura do json;
...
// criar models (para centralizar) para o struct do template de config da aplicação;
// ter um lugar central para escrever e ler o json do template;
// tem um models do payload da api externa;
